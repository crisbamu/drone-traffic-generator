...
{
    public class VLOSParameters
    {
        // Written by Lluís Xavier Herranz on 01/25/2017

        // This class is aimed to store all the values for making VLOS routes and carry them in only one object.
        ...
        public VLOSParameters(double a, double b, double c, double d, double e, double f, double g, double h, double i)
        {
        ...
        public bool AreVLOSParameterWellInserted()
        {
